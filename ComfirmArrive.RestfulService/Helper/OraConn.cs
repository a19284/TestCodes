//string connString = "Provider=OraOLEDB.Oracle.1;User ID=TZWMS;Password=TZWMS;Data Source=(DESCRIPTION = (ADDRESS_LIST= (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.76.128)(PORT = 1521))) (CONNECT_DATA = (SERVICE_NAME = TZWLTEST)))";
using System;
...
namespace Nxt.RestfulService.Helper
{
    /// <summary>
    ...
    public static class OracleHelper
    {
        ...
        private static string connstr = @"Data Source=(DESCRIPTION = (ADDRESS_LIST= (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.76.128)(PORT = 1521))) (CONNECT_DATA = (SERVICE_NAME = TZWLTEST)));User Id=TZWMS;Password=TZWMS;";
